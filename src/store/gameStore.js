 ...
 */
function createInitialGame(players, courseConfig, scoringConfig = DEFAULT_SCORING_CONFIG) {
...
export const useGameStore = create((set, get) => ({
   ...
   */
  createGame: async (players, courseConfig = null, scoringConfig = null) => {
    ...
    const newGame = createInitialGame(players, config, scoring);
