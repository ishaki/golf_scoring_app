/**
 * Fighter Scoring System - Points calculation utilities for golf scoring system
 * This system awards points based on head-to-head comparisons between players
 * with special rules for voor (handicap) holes and tie-breaking
 */
