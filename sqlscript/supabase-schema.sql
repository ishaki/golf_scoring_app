...
-- =====================================================
-- 2. COURSES TABLE
-- Stores golf course configurations
-- =====================================================
...
CREATE INDEX IF NOT EXISTS courses_is_default_idx ON public.courses(is_default);
CREATE INDEX IF NOT EXISTS courses_is_public_idx ON public.courses(is_public);
...
-- =====================================================
-- 3. GAMES TABLE
-- Stores game sessions and scores
-- =====================================================
...
CREATE INDEX IF NOT EXISTS games_public_token_idx ON public.games(public_token);
CREATE INDEX IF NOT EXISTS games_is_complete_idx ON public.games(is_complete);
CREATE INDEX IF NOT EXISTS games_is_public_idx ON public.games(is_public);
...
-- =====================================================
-- 5. INSERT DEFAULT COURSES
-- System preset courses
-- =====================================================
